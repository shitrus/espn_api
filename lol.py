...
def main(): 
    ...
    with open(nextgamecsv, 'w', newline ='') as outcsv:
        ...
        writer.writerow(["teamId", "gameId", "oddsExist", "homeTeamId", "awayTeamId", "awayFavorite", "homeFavorite", "provider", "favorite", "underdog", "spread", "details", "overUnder", "teamId2", "gameId2", "slug", "location", "name", "nickname", "abbreviation", "displayName", "shortDisplayName", "color", "alternateColor"])
